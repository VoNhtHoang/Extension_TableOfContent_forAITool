javascript:(function(){
    ...
    function l(){
        ...
        var d=(r||document).querySelectorAll("div._9663006, div[class*='_4f9bf79'][class*='_43c05b5']");
        console.log(d.length);
        if(!d||d.length===0)
            {s.innerHTML='<li style="opacity:0.7;font-style:italic;">Empty chat</li>';return}
        
        for(var u=0;u<d.length;u++){
            var g=d[u],m=document.createElement("li"),h=g.querySelector("div.fbb737a4"),f=false;
            var z=Math.ceil(u/2);

            console.log(g.classList.contains("_4f9bf79"));
            console.log(h);
            if(g&&g.classList.contains("_4f9bf79")){
    ...
    function y(){
        var e=document.querySelector(".dad65929")||null;
        console.log(e);
        if(e!==r){
